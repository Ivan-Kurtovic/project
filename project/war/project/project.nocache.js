...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "project" because\n';
  ...
  $wnd.__gwt_activeModules['project'] = {
    'moduleName' : 'project',
    'bindings' : function() {
      return {};
    }
 ...
 * "/project.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['project'].superdevmode = true;

  var expectedSuffix = '/project.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + project + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:project';
  var devModeSessionKey = '__gwtDevModeSession:project';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/project/project.nocache.js';
  ...
  $wnd.__gwt_activeModules['project'].canRedirect = true;
  $wnd.__gwt_activeModules['project'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/project?user.agent=' + ua + '&_callback=' + callback;
